                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-11">
                                                    ...
                                                    <input type="text" class="form-control" id="" name="" value="{{ $amendment->brandRight->myipo_ref_no }}" autocomplete="" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-11">
                                                    ...
                                                    <input type="text" class="form-control" id="" name="" value="{{ $amendment->brandRight->brand->name }}" readonly>
                                                </div>
                                            </div>
