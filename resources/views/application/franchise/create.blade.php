                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('application.store') }}" data-parsley-validate>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" id="franchise_type_id" name="franchise_type_id">
...
<script>
    function getFranchiseType() {
        ...
        if (brand) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $('#franchise_type_id').append(response.franchise_type_id);
                    }
            ...
            $('#brandright_id').val('');
            $('#franchise_type_id').append('<option value="" selected="selected"> - Sila Pilih Jenama - </option>');
        }
    }
</script>
@endsection
