                    ...
                    <div class="tab-content">
                        <div class="tab-pane active p-3" id="profile" role="tabpanel">
                            ...
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#capital_equity" role="tab">Maklumat Francaisi</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('application.businessInformation', [$application->id]) }}" role="tab">Maklumat Perniagaan</a>
                                </li>
                            </ul>
                                    ...
                                    <form class="form-horizontal m-t-10" method="POST" action="" data-parsley-validate>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-11">
                                                ...
                                                <br/>
                                                <button class="btn btn-success w-md waves-effect waves-light">Tambah Francaisor</button>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-11">
                                                ...
                                                <textarea class="form-control" id="" name="" value="" rows="3"></textarea>                                         
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-11">
                                                ...
                                                <input type="file" class="form-control-file m-t-10" id="" name="" value="" required>  
                                            </div>
                                        </div>
