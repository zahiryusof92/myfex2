...
class PostcodePerakSeeder extends Seeder {
     ...
     */
    public function run() {
        DB::table('postcodes')->where('state_id', 8)->truncate();
        ...
        $perak = [
            ...
            ['state_id' => 8, 'code' => '31350', 'name' => 'Bougainvilla B/1 - Â B/12'],
            ...
            ['state_id' => 8, 'code' => '31350', 'name' => 'Margosa D/1 - Â D/11'],
        ...
        DB::table('postcodes')->insert($perak);
    }
